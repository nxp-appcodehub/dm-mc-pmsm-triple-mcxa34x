...
mcdef_pmsm_t g_sM2Drive ={
		.psAppSwitch = & g_bM2SwitchAppOnOff,
		.psSpeedAngularScale = & g_fltM2speedAngularScale,
};
...
static const pfc_app_state_fcn s_M2_STATE_RUN_TABLE_FAST[6] = {
...
static const pfc_app_state_fcn s_M2_STATE_RUN_TABLE_SLOW[6] = {
...
static void M2_StateInitFast(void)
{
    ...
    g_sM2Drive.sMCATctrl.ui16PospeSensor  = M2_MCAT_SENSORLESS_CTRL;
    ...
    g_sM2Drive.msBlockedRotorUqFilt.fltLambda = M2_BLOCK_ROT_FAULT_SH;
    ...
    /* Application timing */
    g_sM2Drive.ui16FastCtrlLoopFreq = M2_FAST_LOOP_FREQ;
...
static void M2_StateRunReadyFast(void)
{
    ...
    switch (g_sM2Drive.eControl)
    {
        ...
        default:
            ...
            if ((MLIB_Abs_FLT(g_sM2Drive.sSpeed.fltSpeedCmd) > g_sM2Drive.sFaultThresholds.fltSpeedMin) &&
...
static void M2_StateRunAlignFast(void)
{
    ...
    if ((g_sM2Drive.sMCATctrl.ui16PospeSensor == M2_MCAT_SENSORLESS_CTRL) && (g_sM2Drive.sSpeed.fltSpeedCmd == 0.0F) &&
        (g_sM2Drive.sScalarCtrl.fltFreqCmd == 0.0F))
    {
...
static void M2_ClearFOCVariables(void)
{
    ...
    GDFLIB_FilterMAInit_FLT(0.0F, &g_sM2Drive.msBlockedRotorUqFilt);
...
static void M2_FaultDetection(void)
{
        ...
        (g_eM2StateRun == kRunState_Spin || g_eM2StateRun == kRunState_Freewheel))
    {
        ...
        g_sM2Drive.fltBemfUqAvg =
            GDFLIB_FilterMA_FLT(g_sM2Drive.sFocPMSM.sBemfObsrv.sEObsrv.fltQ, &g_sM2Drive.msBlockedRotorUqFilt);
