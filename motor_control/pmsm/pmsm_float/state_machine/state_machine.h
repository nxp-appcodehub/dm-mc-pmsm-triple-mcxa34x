...
typedef void (*pfc_app_state_fcn)(void);
...
{
    pfc_app_state_fcn Fault;
    pfc_app_state_fcn Init;
    pfc_app_state_fcn Stop;
    pfc_app_state_fcn Run;
} sm_app_state_fcn_t;

/*! @brief User state-transition functions structure */
typedef struct _sm_app_trans_fcn
{
    pfc_app_state_fcn FaultStop;
    pfc_app_state_fcn InitFault;
    pfc_app_state_fcn InitStop;
    pfc_app_state_fcn StopFault;
    pfc_app_state_fcn StopRun;
    pfc_app_state_fcn RunFault;
    pfc_app_state_fcn RunStop;
} sm_app_trans_fcn_t;
