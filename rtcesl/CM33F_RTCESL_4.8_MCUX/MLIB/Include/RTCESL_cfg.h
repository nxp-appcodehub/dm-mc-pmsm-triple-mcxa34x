...
#define RAM_FUNC_LIB          __attribute__((section(".ramfunc")))                    /* function executed from ROM */
#else
#define RAM_FUNC_LIB
#endif
...
#define FAST_FUNC_LIB_FLASH	__attribute__((section(".FlashContinuous")))	/* function executed from flash */

#if defined(CODE_IN_SRAMX)
#define FAST_FUNC_LIB	__attribute__((section(".ramfunc.$SRAMX0")))	/* function executed from SRAMX */
#else
#define FAST_FUNC_LIB	__attribute__((section(".FlashContinuous")))	/* function executed from flash */
#endif
