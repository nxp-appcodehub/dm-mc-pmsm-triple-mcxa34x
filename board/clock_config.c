...
- {id: CLK_1M_clock.outFreq, value: 1 MHz}
- {id: CLK_45M_clock.outFreq, value: 45 MHz}
- {id: CMP0_FUNC_DIV_clock.outFreq, value: 12 MHz}
...
- {id: CMP0_FUNC_CLKDIV_MRCC0_MRCC_CMP0_FUNC_CLKDIV_HALT, value: 'ON'}
...
- {id: MRCC.CMP0_RR_CLKSEL.sel, value: SYSCON.FRO_12M_DIV_clock}
- {id: MRCC.CTIMER0_CLKDIV.scale, value: '1', locked: true}
- {id: MRCC.CTIMER0_CLKSEL.sel, value: SYSCON.FRO_12M_DIV_clock}
- {id: MRCC.LPUART1_CLKSEL.sel, value: SYSCON.FRO_12M_DIV_clock}
- {id: MRCC.TRACE_CLKDIV.scale, value: '2', locked: true}
- {id: SYSCON.FROLFDIV.scale, value: '1', locked: true}
sources:
...
void BOARD_BootClockFROHF180M(void)
{
    ...
    CLOCK_AttachClk(kFRO_LF_DIV_to_LPUART1);               /* !< Switch LPUART1 to FRO_LF_DIV */
    CLOCK_AttachClk(kFRO_HF_to_ADC);                       /* !< Switch ADC to FRO_HF */
    CLOCK_AttachClk(kFRO_LF_DIV_to_CMP0);                  /* !< Switch CMP0 to FRO_LF_DIV */
    ...
    CLOCK_SetClockDiv(kCLOCK_DivCMP0_FUNC, 1U);            /* !< Set MRCC.CMP0_FUNC_CLKDIV divider to value 1 */
    CLOCK_SetClockDiv(kCLOCK_DivCMP1_FUNC, 1U);            /* !< Set MRCC.CMP0_FUNC_CLKDIV divider to value 1 */    
